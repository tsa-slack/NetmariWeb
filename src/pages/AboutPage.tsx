      ...
      <div className="bg-gradient-to-b from-slate-50 to-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4">会社概要</h1>
            ...
            <div className="p-4 md:p-8 space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">202*年月**日</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">****万円</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">代表取締役社長 ＊＊　＊＊</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">**名</p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">****@**************.jp</p>
                    </div>
                  </div>
                </div>
              </div>
